...
feasible_combos_50_df = summary_total_snps_df %>%
  filter(min_N >= 50) %>%
...
write.csv(summary_df,
          str_interp('${dir_output_sumstats}/combinations_2_n_snps_all_strs.csv'),
          row.names=FALSE, quote=FALSE)

write.csv(summary_total_snps_df,
          str_interp('${dir_output_sumstats}/combinations_2_n_snps.csv'),
          row.names=FALSE, quote=FALSE)

write.csv(feasible_combos_50_df,
          str_interp('${dir_output_sumstats}/feasible_combinations_2_50.csv'),
          row.names=FALSE, quote=FALSE)

write.csv(feasible_combos_100_df,
          str_interp('${dir_output_sumstats}/feasible_combinations_2_100.csv'),
          row.names=FALSE, quote=FALSE)
