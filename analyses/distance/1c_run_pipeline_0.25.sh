...
#SBATCH --job-name=submit_jobs_0.25
#SBATCH --time=00:30:00
#SBATCH --mem=1G
#SBATCH --output=logs/submit_jobs_0.25.log
#SBATCH --error=logs/submit_jobs_0.25.err
...
do
  ...
  do
    ...
    do
      ...
      snplist_id=${experiment}_${distance_filter}_${n_snps}_${n_snp_rep}

      # 1. Prepare SNP list
      Rscript make_snplist_distance.R ${experiment} ${n_snps} ${n_snp_rep} ${distance_filter}
...
$experiment $n_snps $n_snp_rep $n_ind_rep $fraction $distance_filter
