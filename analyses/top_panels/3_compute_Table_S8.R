## NEXT STEPS:
#   - Check that each part of this works:
#       1) Combinations
#       2) All SNPs, 18 STRs
#       3) All SNPs, 15 STRs 
#       4) [to be added] values from Kim and Rosenberg 
#   - Then, combine functions to load data and process into outputs
#   - Ensure merging is done properly and produces only one Table S8
