...
#---------------------------#
experiment='extended_best_combinations'
...
# Rscript identify_feasible_and_best_combos_extended.R &&

combos_file="$DIR_OUTPUT_SUMSTATS/extended_best_combinations.csv"
