...
#SBATCH --mem=1G
#SBATCH --output=logs_0.25/submit_jobs_0.25.log
#SBATCH --error=logs_0.25/submit_jobs_0.25.err
...
do
  ...
  do
    ...
    do
      ...
      # 1. Prepare SNP list
      Rscript make_snplist_popmaf.R ${experiment} ${n_snps} ${n_snp_rep} ${popmaf_filter}
...
$experiment $n_snps $n_snp_rep $n_ind_rep $fraction $popmaf_filter
