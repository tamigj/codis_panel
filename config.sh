...
export SELECTED_PANEL_SIZES_CSV="25,50,100"
...
export POPMAF_FILTERS="0 0.01 0.05 0.1"
export DISTANCE_FILTERS="62500 125000 250000"
export PAYSEUR_D_FILTERS="0.3 0.5 0.7 0.9"

export MAF_FILTERS_CSV="0.01,0.05,0.1"
export POPMAF_FILTERS_CSV="0,0.01,0.05,0.1"
export DISTANCE_FILTERS_CSV="62500,125000,250000"
export PAYSEUR_D_FILTERS_CSV="0.3,0.5,0.7,0.9"
