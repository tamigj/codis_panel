...
# Fractions
# export FRACTIONS="0.75 0.5 0.25"
...
export EXTENDED_PANEL_SIZES="10 20 30 40 50"
export EXTENDED_PANEL_SIZES_CSV="10,20,30,40,50"

export EXTENDED_PANEL_SIZES_UP_TO_100="60 70 80 90 100"
export EXTENDED_PANEL_SIZES_UP_TO_100_CSV="60,70,80,90,100"
...
export R2_THRESHOLDS="0.3 0.5 0.7"
...
export R2_THRESHOLDS_CSV="0.3,0.5,0.7"
